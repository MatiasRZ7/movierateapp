...
export const Rated = () => {
    ...
    return (
        <Container style={{marginTop: 50}}>
            <Menu pointing secondary className={darkMode ? 'dark-mode' : 'light-mode'}>
            ...
            <Segment>
                ...
                <div>
                    ...
                    {ratedMovies.results && <ColumnDisplay data={ratedMovies.results} displayType={DisplayType.Movies} isRated/>}
                </div> 
                ) : (
                <div>
                    <Header as="h2">Rated TV Shows</Header>
                    {ratedTvShows.results && <ColumnDisplay data={ratedTvShows.results} displayType={DisplayType.TvShows} isRated/>}
                </div> 
                )}
            </Segment>     
         </Container>   
